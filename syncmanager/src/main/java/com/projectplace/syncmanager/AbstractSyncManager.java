 ...
 * token to work.
 */
public abstract class AbstractSyncManager implements SyncObject.SyncListener {
    ...
    protected AbstractSyncManager(Context context) {
        ...
        public void run() {
            while (!mSyncStopped) {
                ...
                synchronized (mSyncLock) {
                    ...
                    } else if (syncObject != null && shouldRefreshAccessToken(syncObject)) {
